...
<head>
  ...
  <title>Pendaftaran Tamu Mahasiswa</title>
  ...
  <div class="container login-container">
    <div class="row align-items-center">
      <div class="col-md-6 text-center">
        <img
          src="//learning-if.polibatam.ac.id/pluginfile.php/1/theme_moove/logo/1756270195/01_Logo_1_Utama_Polibatam_Vertikal%402x.png"
          alt="Polibatam Logo" class="logo">
      </div>
      ...
      <div class="col-md-6 d-flex justify-content-center">
        <div class="login-card">
          ...
          <form action="form_tamu_mahasiswa.php" method="POST">
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input type="number" class="form-control" id="no_id" name="no_id"
                value="<?php echo isset($_POST['no_id']) ? htmlspecialchars($_POST['no_id']) : ''; ?>" required>
            </div>
            <div class="mb-3">
              <label>Kampus :</label>
              <input type="text" class="form-control" id="institusi" name="institusi"
                value="<?php echo isset($_POST['institusi']) ? htmlspecialchars($_POST['institusi']) : ''; ?>" required>
            </div>
            <div class="mb-3">
              <label>Alamat :</label>
            ...
            <div class="mb-3">
              ...
              <textarea name="message" rows="5" cols="34" placeholder="Tuliskan Pesan Anda"
