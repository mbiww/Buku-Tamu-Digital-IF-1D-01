...
<head>
    ...
    <link rel="stylesheet" href="style_mahasiswa.css">
</head>
<body>
    <div class="header">
        <div class="container">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="guidelines">
                    ...
                    <ul>
                        ...
                        <li>Nomor identitas (NIM) harus berupa angka</li>
            ...
            <div class="col-md-6">
                <div class="form-card mt-4">
                    <h5 class="text-center mb-4 fw-bold">Pendaftaran Tamu Mahasiswa</h5>
            ...
            submitBtn.addEventListener('click', function(e) {
                ...
                .then(data => {
                    ...
                    if (data.success) {
                        ...
                        // Auto tutup modal setelah 3 detik
                        setTimeout(() => {
