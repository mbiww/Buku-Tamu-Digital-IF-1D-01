                    ...
                    <div class="card-body">
                                    ...
                                    <?php if (mysqli_num_rows($tamu) > 0): ?>
                                        ...
                                        while ($data = mysqli_fetch_array($tamu)):
                                            ...
                                            <tr>
                                                ...
                                                <td><?= htmlspecialchars($data['nama_lengkap']); ?><br><small>(<?= htmlspecialchars($data['no_id']); ?>)</small>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <?php if ($data['status_aktif'] === 'aktif'): ?>
                                                        <form method="POST" style="display:inline;">
                                                            ...
                                                            <button type="submit" class="badge-checkout"
                        ...
                        <?php if (mysqli_num_rows($tamu) > 0 && $total_pages > 1): ?>
                            <div class="pagination-container">
                                ...
                                if (!empty($jenis_filter) && $jenis_filter != 'semua')
                                    $query_params['jenis_tamu'] = $jenis_filter;
                                if (!empty($tanggal_filter))
                                    $query_params['tanggal'] = $tanggal_filter;
                                if (!empty($status_filter) && $status_filter != 'semua')
                                ...
                                <?php if ($page < $total_pages): ?>
                                    ...
                                    <a href="dashboard_admin.php?<?= http_build_query($query_params) ?>" class="pagination-btn">
                        ...
                        <form method="GET" action="">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="jenis_tamu">
                                    ...
                                    <option value="mahasiswa" <?= $jenis_filter == 'mahasiswa' ? 'selected' : '' ?>>
                                        Mahasiswa</option>
                                    <option value="instansi" <?= $jenis_filter == 'instansi' ? 'selected' : '' ?>>Instansi
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <select class="form-select" name="status">
                                    ...
                                    <option value="tidak aktif" <?= $status_filter == 'tidak aktif' ? 'selected' : '' ?>>
                                        Tidak Aktif</option>
                                </select>
                            </div>
